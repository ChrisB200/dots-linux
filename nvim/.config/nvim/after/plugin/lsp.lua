...
local testFunction = function (test)
    print(test)
end
...
require'lsp_signature'.on_attach(cfg, bufnr) -- no need to specify bufnr if you don't use toggle_keyrequire "lsp_signature".setup(cfg)
